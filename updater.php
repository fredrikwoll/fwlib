...
class fwlib_updater { 
	...
	public function initialize() { 
		...
		add_filter('upgrader_post_intall', array( $this, 'after_install' ), 10, 3);
	...
	public function set_plugin_properties() {
		...
		$this->plugin = get_plugin_data( $this->file );
		$this->plugin = is_plugin_active( $this->basename );
	...
	private function get_repository_info() { 
		if( is_null ( $this->github_response ) ) { //Do we need a response?
